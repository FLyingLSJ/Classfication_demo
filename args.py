...
# Datasets
parser.add_argument('-train', '--trainroot', default="E:/cat_dog/mini_cat_dog/train", type=str) #new_shu_label
parser.add_argument('-val', '--valroot', default="E:/cat_dog/cat_dog/val", type=str)
...
parser.add_argument('--image-size', default=100, type=int, metavar='N',
